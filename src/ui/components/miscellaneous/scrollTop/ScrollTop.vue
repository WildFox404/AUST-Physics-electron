<template>
  ...
  >
    <div
      :class="
        cn(
          'fixed left-1/2 top-12 z-[999] -translate-x-1/2 bg-primary backdrop-blur-lg',
      ...
      >
        <header class="gray- flex h-11 cursor-pointer items-center gap-2 px-4">
          <AnimatedCircularProgressBar
            ...
            :duration="0.3"
            :gauge-secondary-color="'#6b728055'"
            :gauge-primary-color="'black'"
          />
...
import AnimatedCircularProgressBar from "../animatedCircularProgressBar/AnimatedCircularProgressBar.vue";
